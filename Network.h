...
IPAddress local_IP(192, 168, 2, 88); // Set your server's fixed IP address here
IPAddress gateway(192, 168, 2, 1);    // Set your network Gateway usually your Router base address
IPAddress subnet(255, 255, 255, 0);   // Set your network sub-network mask here
IPAddress dns(192, 168, 2, 1);           // Set your network DNS usually your Router base address
